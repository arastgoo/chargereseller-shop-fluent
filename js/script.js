    ...
    function checkForm() {
        ...
        switch (kind) {
            case 'TopUp':
                ...
                if ((jQuery.inArray(cellphone.substring(0, 3), ['093', '090', '091']) === -1 && jQuery.inArray(cellphone.substring(0, 4), ['0921', '0922', '0990','0991']) === -1) && $('#dataType').val() !== 'WiMax') {
            ...
            case 'Pin':
                ...
                if (jQuery.inArray(cellphone.substring(0, 3), ['093', '090', '091', '092']) === -1 && jQuery.inArray(cellphone.substring(0, 4), ['0921', '0922', '0920', '0990','0991']) === -1) {
                    swal('توجه!', 'شماره موبایل وارد شده صحیح نیست.', 'warning');
                    return;
                }
            ...
            case 'Bill':
                ...
                if (jQuery.inArray(cellphone.substring(0, 3), ['093', '090', '091', '092']) === -1 && jQuery.inArray(cellphone.substring(0, 4), ['0990','0991','0921', '0922', '0920',]) === -1) {
                    swal('توجه!', 'شماره موبایل وارد شده صحیح نیست.', 'warning');
                    return;
                }
                break;
